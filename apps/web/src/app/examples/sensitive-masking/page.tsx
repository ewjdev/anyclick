        ...
        <div className="mb-12 p-8 rounded-2xl bg-linear-to-br from-emerald-500/10 to-violet-500/10 border border-emerald-500/20">
          ...
          <div className="space-y-6 p-6 rounded-xl bg-white/5 border border-white/10 mt-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Elements with{" "}
                  <code className="text-amber-400">.sensitive</code> class are
                  masked
                </p>
              </div>
          ...
          <div className="mt-6 p-4 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
            <p className="text-sm text-emerald-400 flex items-start gap-2">
              ...
              <span>
                All sensitive elements above are automatically detected and
                masked in screenshots. Try right-clicking any element and
                submitting feedback to see the masked preview!
              </span>
            </p>
          </div>
        </div>
