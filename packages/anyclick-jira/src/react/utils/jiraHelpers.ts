...
export function extractPrimitiveValue(value: unknown): string {
  ...
  if (typeof value === "object") {
    ...
    if (obj.id !== undefined && typeof obj.id !== "object") {
      return String(obj.id);
    }
    if (obj.value !== undefined && typeof obj.value !== "object") {
      return String(obj.value);
    }
    if (obj.name !== undefined && typeof obj.name !== "object") {
      return String(obj.name);
    }
    if (obj.key !== undefined && typeof obj.key !== "object") {
      return String(obj.key);
    }
    if (obj.accountId !== undefined) return String(obj.accountId);
...
/**
 * Merges multiple style objects together, filtering out undefined values.
 * This replaces the cn() utility from Tailwind for conditional styling.
 */
