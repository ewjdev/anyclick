...
- 1900c61: Add opt-in scoped conversations with full structured message support, accessible command and object completion, editable action results, and docked/floating/sheet presentations. Export the shared stylesheet and keep existing QuickChat consumers compatible through an optional conversation prop.
...
- Updated dependencies [6ed32b5]
- Updated dependencies [b6b800d]
- Updated dependencies [c33f30a]
  - @ewjdev/anyclick-devtools@5.1.2
...
- Updated dependencies [353c4ca]
  - @ewjdev/anyclick-devtools@5.1.0
  - @ewjdev/anyclick-pointer@5.1.0
